package com.view.gameWindow.mainUi.subuis.chatframe.msg
{
	 ...
	 * 2014-8-14
	 */
	public class MessageFactoryArea extends MessageFactory /*implements IMessageFactory*/
	{
		public function MessageFactoryArea()
		{
			_formatColor = 0xffffff;
		}
		...
		{
			var iconData:BitmapData = MessageCfg.IMG_STORE[MessageCfg.URL_AREA];
