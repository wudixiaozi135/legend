package com.view.gameWindow.mainUi.subuis.musicSet
{
     ...
     */
    public class MusicSettingEvent extends Request
    {
        /**音乐设置*/
        ...
        public function MusicSettingEvent(type:String, value:Object = null, bubbles:Boolean = false, cancelable:Boolean = false)
        {
