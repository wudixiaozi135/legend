package com.view.gameWindow.mainUi.subuis.displaySetting.item
{
     ...
     */
    public class DisplaySettingItem extends CheckItemBase
    {
        public function DisplaySettingItem()
        {
            super();
            _skin = new McSetting();
            addChild(_skin);
        ...
        private function checkHandler():void
        {
            ...
            DisplaySettingManager.instance.dispatchEvt(this);
        }
