package com.view.gameWindow.panel.panels.hero.tab3
{
	 ...
	 */	
	public class EntityModeInImagelHandle
	{
		...
		public function EntityModeInImagelHandle(layer:MovieClip)
		{
		...
		public function changeModel(fashion:int):void
		{
			isInit = false;
			var sex:int = HeroDataManager.instance.sex;
			var oldEntityModel:EntityModel = _entityModel;
			_entityModel = EntityModelUtil.getEntityModel(0, fashion, 0, 0, 0, 0, 0, sex, ActionTypes.NOACTION, EntityModel.N_DIRECTION_8);
