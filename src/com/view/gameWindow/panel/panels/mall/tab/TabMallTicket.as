package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallTicket extends MallTabBase
	{
		public function TabMallTicket()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_TICKET);
		}
