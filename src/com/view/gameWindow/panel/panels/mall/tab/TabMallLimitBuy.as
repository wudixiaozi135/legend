package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallLimitBuy extends MallTabBase
	{
		public function TabMallLimitBuy()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_LIMIT_BUY);
		}
