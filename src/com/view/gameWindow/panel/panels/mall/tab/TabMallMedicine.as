package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallMedicine extends MallTabBase
	{
		public function TabMallMedicine()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_MEDICINE);
		}
