package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallFashion extends MallTabBase
	{
		public function TabMallFashion()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_FASHION);
		}
