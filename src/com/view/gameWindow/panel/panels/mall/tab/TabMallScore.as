package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallScore extends MallTabBase
	{
		public function TabMallScore()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_SCORE);
		}
