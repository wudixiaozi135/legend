package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallHotSell extends MallTabBase
	{
		public function TabMallHotSell()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_HOT_SELL);
		}
