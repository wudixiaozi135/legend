package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallStrength extends MallTabBase
	{
		public function TabMallStrength()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_STRENGTH);
		}
