package com.view.gameWindow.panel.panels.mall.tab
{
	 ...
	 */
	public class TabMallSkill extends MallTabBase
	{
		public function TabMallSkill()
		{
		...
		{
			_dataItems = _dataItems || MallDataManager.instance.getVecCfgByShelf(ShopShelfType.TYPE_SKILL);
		}
