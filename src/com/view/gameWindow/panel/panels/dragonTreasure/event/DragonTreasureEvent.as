package com.view.gameWindow.panel.panels.dragonTreasure.event
{
	 ...
	 */
	public class DragonTreasureEvent extends Event
	{
		/**切换标签页*/
		...
		public function DragonTreasureEvent(type:String, param:Object = null, bubbles:Boolean = false, cancelable:Boolean = false)
		{
