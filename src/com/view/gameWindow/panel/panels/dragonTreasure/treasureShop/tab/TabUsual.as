package com.view.gameWindow.panel.panels.dragonTreasure.treasureShop.tab
{
	...
	public class TabUsual extends MallTabBase
	{
		...
		{
			_dataItems = _dataItems || TreasureShopManager.instance.getVecCfgByShelf(TreasureShopType.SHELF_USUAL);
