package com.view.gameWindow.panel.panels.stall.otherstall
{
     ...
     */
    public class PanelOtherStall extends PanelBase
    {
        private var _mouseHandler:StallOtherMouseHandler;
        private var _viewHandler:StallOtherViewHandler;

        public function PanelOtherStall()
        {
            super();
        }
        ...
        {
            _viewHandler = new StallOtherViewHandler(this);
            _mouseHandler = new StallOtherMouseHandler(this);
        }
