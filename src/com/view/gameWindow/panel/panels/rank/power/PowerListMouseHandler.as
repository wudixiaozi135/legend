package com.view.gameWindow.panel.panels.rank.power
{
	...
	public class PowerListMouseHandler
	{
		private var panel:PowerListPanel;
		private var skin:McLevelPanel;
		private var roleMenu:RoleMenu;

		public function PowerListMouseHandler(panel:PowerListPanel)
		{
			this.panel = panel;
		...
		{
			var item:PowerListItem=event.target.parent as PowerListItem;
