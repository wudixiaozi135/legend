package com.view.gameWindow.panel.panels.rank.coin.item
{
	...
	import com.view.gameWindow.panel.panels.rank.gold.item.McItem;
	import com.view.gameWindow.util.HtmlUtils;
	
	import flash.display.Bitmap;
	import flash.display.BitmapData;
	
	public class CoinListItem extends McItem
	{
		private var _data:RankMemberData;
		private const NO_SCHOOL:int=0;
		private var icon:Bitmap;
		public function CoinListItem()
		{
			super();
		}
		...
		public function update(data:RankMemberData):void
		{
			...
			txt5.htmlText=HtmlUtils.createHtmlStr(color,data.unbindCoin+"");
