package com.view.gameWindow.panel.panels.rank.coin
{
	...
	public class CoinlListMouseHandler
	{
		private var panel:CoinListPanel;
		private var skin:McGoldlPanel;
		private var roleMenu:RoleMenu;

		public function CoinlListMouseHandler(panel:CoinListPanel)
		{
			this.panel = panel;
			skin = panel.skin as McGoldlPanel;
		...
		{
			var item:CoinListItem=event.target.parent as CoinListItem;
