package com.view.gameWindow.panel.panels.rank.level.item
{
	...
	public class LevelListItem extends McItem
	{
		private var _data:RankMemberData;
		private const NO_SCHOOL:int=0;
		private var icon:Bitmap;
		public function LevelListItem()
		{
			super();
		}
...
//			}
			txt3.htmlText=HtmlUtils.createHtmlStr(color,JobConst.jobName(data.job));
			txt4.htmlText=HtmlUtils.createHtmlStr(color,SexConst.sexName(data.sex));
//			txt4.htmlText=HtmlUtils.createHtmlStr(color,JobConst.jobName(data.job));
			txt5.htmlText=HtmlUtils.createHtmlStr(color,data.familyName);
		}
