package com.view.gameWindow.panel.panels.search
{
	 ...
	 * 2014-11-10
	 */
	public class SearchFriendPanel extends SearchPanel
	{
		public function SearchFriendPanel()
		{
			super();
		}
		...
		override protected function initSkin():void
		{
			...
			_mc.btnLabel2.text = "加友";
			_mc.btnLabel2.mouseEnabled = false;
			
			_name = PanelConst.TYPE_SEARCH_FOR_FRIEND;
		}
		...
		override protected function clickHandler(e:MouseEvent):void
		{
			...
			if(e.target == _mc.btn2)
			{
				if(_list.selectedIndex>=0)
				{
					...
					{
						dataMgr.requestAddContact(data.serverId,data.roleId,ContactType.FRIEND)
					}
