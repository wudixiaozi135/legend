package com.view.gameWindow.panel.panels.boss.outside
{
	...
	public class TabOutsideBoss extends TabBase
	{
		private var _viewHandle:TabOutsideViewHandle;
		
		public function TabOutsideBoss()
		{
			super();
		}
		...
		{	 
			_viewHandle = new TabOutsideViewHandle(this);
